...
- (void)showBadgeWithStyle:(WBadgeStyle)style text:(NSString *)text animationType:(WBadgeAnimType)aniType
{
        [kActualView showBadgeWithStyle:style text:text animationType:aniType];
}
