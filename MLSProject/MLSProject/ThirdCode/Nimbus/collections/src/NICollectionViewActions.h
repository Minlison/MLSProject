...
@protocol NICollectionViewDelegate <UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
@end
 ...
 */
@interface NICollectionViewActions : NIActions <NICollectionViewDelegate>
