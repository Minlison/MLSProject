...
{
    //配置广告数据
    XHLaunchImageAdConfiguration *configuration = [[XHLaunchImageAdConfiguration alloc] init];
    //广告停留时间
...
{
    //配置广告数据
    XHLaunchVideoAdConfiguration *configuration = [[XHLaunchVideoAdConfiguration alloc] init];
    //广告停留时间
    configuration.duration = 5;
    //广告frame
    configuration.frame = [UIScreen mainScreen].bounds;
