...
- (void)showPhotoDisplayController
{
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
        ...
        UIBarButtonItem *cancel = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringWithDefaultValue(@"Cancel",@"DZNPhotoPickerController",[NSBundle mainBundle],nil,@"") style:UIBarButtonItemStylePlain target:self action:@selector(cancelPicker:)];
