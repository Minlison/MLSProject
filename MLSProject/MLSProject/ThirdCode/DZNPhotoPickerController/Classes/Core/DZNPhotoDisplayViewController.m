...
- (void)commontInit
{
    ...
    self.title = NSLocalizedStringWithDefaultValue(@"Internet Photos",@"DZNPhotoPickerController",[NSBundle mainBundle],nil,@"");
    self.currentPage = 0;
}
...
- (UISearchController *)searchController
{
    if (!_searchController) {
        ...
        searchBar.placeholder = NSLocalizedStringWithDefaultValue(@"Search",@"DZNPhotoPickerController",[NSBundle mainBundle],nil,@"");
...
- (UIButton *)loadButton
{
    if (!_loadButton) {
        ...
        [_loadButton setTitle:NSLocalizedStringWithDefaultValue(@"Load More",@"DZNPhotoPickerController",[NSBundle mainBundle],nil,@"") forState:UIControlStateNormal];
...
- (NSAttributedString *)titleForEmptyDataSet:(UIScrollView *)scrollView
{
    ...
    if (self.error) {
        ...
        text = NSLocalizedStringWithDefaultValue(@"Error",@"DZNPhotoPickerController",[NSBundle mainBundle],nil,@"");
    }
    else if (!self.loading) {
            
        text = NSLocalizedStringWithDefaultValue(@"No Photos Found",@"DZNPhotoPickerController",[NSBundle mainBundle],nil,@"");
    }
...
- (NSAttributedString *)descriptionForEmptyDataSet:(UIScrollView *)scrollView
{
    ...
    if (self.error) {
        ...
        text = NSLocalizedStringWithDefaultValue(@"Make sure that all words are\nspelled correctly.",@"DZNPhotoPickerController",[NSBundle mainBundle],nil,@"");
    }
