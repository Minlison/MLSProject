...
@property (nonatomic, strong, readonly) id<FXForm> form;
@property (nonatomic, strong, readonly) NSString *key;
@property (nonatomic, strong, readonly) NSString *type;
@property (nonatomic, strong, readonly) NSString *title;
@property (nonatomic, strong, readonly) id placeholder;
@property (nonatomic, strong, readonly) NSDictionary *fieldTemplate;
@property (nonatomic, assign, readonly) BOOL isSortable;
...
@interface FXFormViewController : BaseViewController <FXFormFieldViewController, FXFormControllerDelegate>
...
@property (nonatomic, strong, readonly) UITableViewCell <FXFormFieldCell> *nextCell;

- (void)setUp;
- (void)update;
// 是否允许在 layoutSubviews 方法里调整位置，默认为 YES
...
@property (nonatomic, strong, readonly) US2ValidatorTextField *textField;
...
@property (nonatomic, strong, readonly) UIImageView *imagePickerView;
