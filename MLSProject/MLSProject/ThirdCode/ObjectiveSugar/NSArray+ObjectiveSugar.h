...
@interface NSArray <ObjectType> (ObjectiveSugar)
 ...
 */
- (ObjectType)first DEPRECATED_MSG_ATTRIBUTE("Please use -firstObject instead");
 ...
 */
- (ObjectType)last DEPRECATED_MSG_ATTRIBUTE("Please use -lastObject instead");
 ...
 */
- (ObjectType)objectForKeyedSubscript:(ObjectType <NSCopying>)key;
...
/**
 ...
 @return An array of elements
 */
- (NSArray *)takeWhile:(BOOL (^)(ObjectType object))block;
 ...
 */
- (NSArray *)select:(BOOL (^)(ObjectType object))block;
 ...
 */
- (ObjectType)detect:(BOOL (^)(ObjectType object))block;
...
/**
 ...
 @return The first matching element
 */
- (ObjectType)find:(BOOL (^)(ObjectType object))block;
 ...
 */
- (NSArray *)reject:(BOOL (^)(ObjectType object))block;
 ...
 **/
- (ObjectType)reduce:(ObjectType (^)(ObjectType accumulator, ObjectType object))block;

/**
 Same as -reduce, with initial value provided by yourself
 **/
- (ObjectType)reduce:(ObjectType)initial withBlock:(ObjectType (^)(ObjectType accumulator, ObjectType object))block;
