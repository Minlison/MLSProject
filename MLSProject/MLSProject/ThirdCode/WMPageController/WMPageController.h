...
typedef NS_ENUM(int, WMPageControllerScrollDirection) {
	WMPageControllerScrollDirectionHorizontal,
	WMPageControllerScrollDirectionVertical,
};
...
/** 是否显示顶部头视图 */
@property (nonatomic, assign) BOOL showMenuView;
...
/**
 方位
 */
@property (assign, nonatomic) WMPageControllerScrollDirection direction;
/**
...
@interface NSDictionary (WMPageController)
