...
typedef NS_OPTIONS(NSUInteger, QMUIBorderViewPosition) {
    ...
    QMUIBorderViewPositionRight     = 1 << 3,
        QMUIBorderViewPositionAll     = QMUIBorderViewPositionTop | QMUIBorderViewPositionLeft | QMUIBorderViewPositionBottom | QMUIBorderViewPositionRight,
};
...
/// 边框是否是阴影渐变
@property(nonatomic, assign) IBInspectable BOOL qmui_enableShadow;
/// 阴影透明度
@property(nonatomic, assign) IBInspectable CGFloat qmui_shadowOpacity;
/// 阴影颜色
@property(nonatomic, strong) IBInspectable UIColor *qmui_shadowColor;
