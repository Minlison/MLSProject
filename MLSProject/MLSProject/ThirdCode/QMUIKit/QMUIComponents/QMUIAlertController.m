...
+ (void)resetAppearance {
    if (!alertControllerAppearance) {
        ...
        alertControllerAppearance = [[QMUIAlertController alloc] init];
            alertControllerAppearance.alertBackgroundColor = [UIColor clearColor];
        ...
        alertControllerAppearance.alertTitleMessageSpacing = 3;
            ...
            alertControllerAppearance.sheetBackgroundColor = [UIColor clearColor];
...
- (void)didInitialized {
    if (alertControllerAppearance) {
            self.alertBackgroundColor = [QMUIAlertController appearance].alertBackgroundColor;
        ...
        self.alertTitleMessageSpacing = [QMUIAlertController appearance].alertTitleMessageSpacing;
            ...
            self.sheetBackgroundColor = [QMUIAlertController appearance].sheetBackgroundColor;
...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message preferredStyle:(QMUIAlertControllerStyle)preferredStyle {
    ...
    if (self) {
        ...
        self.containerView = [[UIView alloc] init];
            if (preferredStyle == QMUIAlertControllerStyleActionSheet) {
