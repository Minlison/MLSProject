...
//            currentViewController.navigationItem.backBarButtonItem = [QMUINavigationButton barButtonItemWithType:QMUINavigationButtonTypeNormal title:@"" position:QMUINavigationButtonPositionLeft target:nil action:NULL];
                UIBarButtonItem *backItem =[QMUINavigationButton barButtonItemWithImage:[UIImage nav_ic_back_blackRenderingMode:(UIImageRenderingModeAlwaysOriginal)] position:(QMUINavigationButtonPositionLeft) target:nil action:nil];
...
//    self.delegateProxy = delegate != self ? delegate : nil;
        ...
        if (delegate == nil)
        {
                self.delegateInterceptor.middleMan = nil;
        ...
        {
                self.delegateInterceptor = [[WZProtocolInterceptor alloc] initWithInterceptedProtocol:@protocol(UINavigationControllerDelegate)];
                self.delegateInterceptor.middleMan = self;
                self.delegateInterceptor.receiver = delegate;
                [super setDelegate:(id<UINavigationControllerDelegate>)self.delegateInterceptor];
        }
}
...
- (void)navigationController:(UINavigationController *)navigationController willShowViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    } else if ([self.delegateInterceptor.receiver respondsToSelector:_cmd]) {
            [self.delegateInterceptor.receiver navigationController:navigationController willShowViewController:viewController animated:animated];
    }
}
...
- (void)navigationController:(UINavigationController *)navigationController didShowViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if ([self.delegateProxy respondsToSelector:_cmd]) {
        [self.delegateProxy navigationController:navigationController didShowViewController:viewController animated:animated];
            ...
            [self.delegateInterceptor.receiver navigationController:navigationController didShowViewController:viewController animated:animated];
    }
}
