...
- (void)setupPageControl
{
	...
	[self resetPageControlIndex:self.mainView];
}

- (void)resetPageControlIndex:(UIScrollView *)scrollView
{
...
- (void)automaticScroll
{
	...
	if (self.imagesGroup.count <= 1) return;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if (self.imageURLStringsGroup != nil && self.imageURLStringsGroup.count > itemIndex)
	{
		[cell.imageView sd_setImageWithURL:[NSURL URLWithString:self.imageURLStringsGroup[itemIndex]] placeholderImage:image];
	}
	else
	{
		cell.imageView.image = image;
