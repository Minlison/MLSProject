                 ...
                 minimumFontSize:(int)minFontSize
{
  ...
  // Now, calculate the size of the label constrained to maxSize
        ...
        CGSize tempSize = [[self text] boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : [self font], NSParagraphStyleAttributeName : paragraph} context:nil].size;
#else
  ...
  do {
    ...
    // Calculate the frame size
          ...
          calculatedSizeWithCurrentFontSize = [[self text] boundingRectWithSize:unconstrainedSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : labelFont, NSParagraphStyleAttributeName : paragraph} context:nil].size;
#else
