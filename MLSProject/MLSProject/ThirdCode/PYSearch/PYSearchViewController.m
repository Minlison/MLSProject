...
- (void)viewDidLayoutSubviews
{
    ...
    self.cancelButtonWidth = cancelButton.py_width > self.cancelButtonWidth ? cancelButton.py_width : self.cancelButtonWidth;
        self.leftItemWidth = self.navigationItem.leftBarButtonItem ? self.cancelButtonWidth : 0;
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 11.0) { // iOS 11
        ...
        navBar.layoutMargins = UIEdgeInsetsZero;
            /// MARK: - Same as UINavigation+SXFixSpace
        CGFloat space = 3;
        ...
        _searchBar.py_width = self.view.py_width - self.cancelButtonWidth - self.leftItemWidth - PYSEARCH_MARGIN * 3 - 8;
        _searchBar.py_height = self.view.py_width > self.view.py_height ? 24 : 30;
        _searchTextField.frame = _searchBar.bounds;
    } else {
        UIView *titleView = self.navigationItem.titleView;
        titleView.py_x = self.leftItemWidth + PYSEARCH_MARGIN * 1.5;
        titleView.py_y = self.view.py_width > self.view.py_height ? 3 : 7;
        titleView.py_width = self.view.py_width - self.cancelButtonWidth - self.leftItemWidth - titleView.py_x * 2 - 3;
...
//            self.navigationController.navigationBar.barTintColor = UIColorHex(0x0190D4);
//        }
    }
}
/// MARK: Custom Method
...
//            searchSuggestionVC.view.frame = CGRectMake(0,0, PYScreenW, PYScreenH);
        ...
        _searchSuggestionVC = searchSuggestionVC;
            [_searchSuggestionView mas_remakeConstraints:^(MASConstraintMaker *make) {
    ...
    for (UIView *subView in [[searchBar.subviews lastObject] subviews]) {
        if ([[subView class] isSubclassOfClass:[UITextField class]]) {
            ...
            textField.font = [UIFont systemFontOfSize:16];
                textField.backgroundColor = UIColorHex(0xE6E6EA);
