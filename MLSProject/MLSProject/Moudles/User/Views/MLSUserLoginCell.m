...
#import "MLSUserLoginCell.h"
#import "MZTimerLabel.h"
static const CGFloat bootomLineWidth = 1;
@interface MLSUserLoginCell ()
...
@implementation MLSUserLoginCell
...
- (void)setRightType:(WGUserLoginCellRightViewType)rightType
{
...
- (void)_reLayout
{
        ...
        if (self.rightType == WGUserLoginCellRightTypeCountDown)
        {
