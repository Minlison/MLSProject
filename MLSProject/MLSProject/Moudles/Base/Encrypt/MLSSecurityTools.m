...
#define __PASSWORD_KEY__        @"GJF6y0vFeRmzOwCFBqxkgS=="
...
@implementation NSDictionary (CZSecurity)
...
@implementation NSData (CZSecurity)
...
@implementation NSString (CZSecurity)
...
@implementation NSArray (CZSecurity)
/**
 aes_base64 加密后的字符串
 */
- (NSString *)aes_base64_encryptString
