...
@protocol NetworkRequesSubClassHoldertDelegate <NSObject>
...
/**
  代理
 */
@property(nonatomic, weak, nullable) id <NetworkRequesSubClassHoldertDelegate> subClassHoldertDelegate;
