...
+ (instancetype)shareCache
{
        ...
        dispatch_once(&onceToken, ^{
                instance = [[self alloc] initWithName:@"com.mlsproject.jsoncache"];
...
+ (instancetype)staticCache
{
        ...
        static dispatch_once_t onceToken;
        dispatch_once(&onceToken, ^{
                instance = [[self alloc] initWithName:@"com.mlsproject.staticcache"];
...
+ (instancetype)signCache
{
        ...
        static dispatch_once_t onceToken;
        dispatch_once(&onceToken, ^{
                instance = [[self alloc] initWithName:@"com.mlsproject.signcache"];
