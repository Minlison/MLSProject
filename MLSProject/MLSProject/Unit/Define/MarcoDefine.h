...
//屏幕适配
#define __WGWidth(w)      (IS_IPHONE ? ((w/375.0)*__MAIN_SCREEN_WIDTH__) : ((w/900.0)*__MAIN_SCREEN_HEIGHT__))
#define __WGHeight(h)     (IS_IPHONE ? ((h/667.0)*__MAIN_SCREEN_HEIGHT__) : ((h/1024.0)*__MAIN_SCREEN_HEIGHT__))
/// 版本判断
