...
#define UIColorGray5 UIColorHex(0x999999)
#define UIColorGray6 UIColorMake(153, 160, 170)
#define UIColorGray7 UIColorHex(0xdddddd)
#define UIColorGray8 UIColorHex(0xf0f0f0)
#define UIColorGray9 UIColorHex(0xf0f0f0)
