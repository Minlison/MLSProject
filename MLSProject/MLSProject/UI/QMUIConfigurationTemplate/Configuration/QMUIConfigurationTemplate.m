...
#pragma mark - Global Color
        ...
        QMUICMI.blackColor = UIColorHex(0x545454); // [UIColor colorWithRed:0 green:0 blue:0 alpha:1];       // UIColorBlack : 黑色（不用 [UIColor blackColor] 是希望保持颜色空间为 RGB）
...
#pragma mark - NavigationBar
        ...
        QMUICMI.navBarBackIndicatorImage = [UIImage nav_ic_back_blackRenderingMode:(UIImageRenderingModeAlwaysOriginal)];                                     // NavBarBackIndicatorImage : 导航栏的返回按钮的图片
